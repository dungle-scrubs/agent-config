...
ln -sf "$SCRIPT_DIR/shared/instructions.md" ~/.claude/CLAUDE.md
ln -sf "$SCRIPT_DIR/shared/commands" ~/.claude/commands
ln -sf "$SCRIPT_DIR/shared/skills" ~/.claude/skills
...
ln -sf "$SCRIPT_DIR/shared/commands" ~/.codex/commands
ln -sf "$SCRIPT_DIR/shared/skills" ~/.codex/skills
...
if [[ -f "$WORK_DIRS_CONFIG" ]]; then
    while IFS= read -r line || [[ -n "$line" ]]; do
        ...
        if [[ -n "$config_dir" && -d "$config_dir" ]]; then
            ...
            ln -sf "$SCRIPT_DIR/shared/instructions.md" "$config_dir/CLAUDE.md"
            ln -sf "$SCRIPT_DIR/shared/commands" "$config_dir/commands"
            ln -sf "$SCRIPT_DIR/shared/skills" "$config_dir/skills"
