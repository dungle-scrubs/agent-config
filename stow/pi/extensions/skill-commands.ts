 ...
 *
 * Usage: Set `enableSkillCommands: false` in settings.json to disable
 * the built-in `/skill:name` syntax, then this extension provides `/skill-name`.
 */
