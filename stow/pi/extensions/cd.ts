...
export default function (pi: ExtensionAPI) {
  ...
  pi.registerTool({
    ...
    description: "Change the current working directory. Use this before running commands that need to be in a specific directory.",
    parameters: Type.Object({
      path: Type.String({ description: "Directory path (absolute or relative, ~ expands to home)" }),
    }),
